...
// store (the AssetSaver capability on the coordinator handler). A handler without
// the capability fails closed rather than writing a local-only file that would
