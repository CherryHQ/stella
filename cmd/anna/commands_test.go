...
func TestNewRunnerFactoryGo(t *testing.T) {
	...
	factory, err := agent.NewRunnerFactory(snap, nil, nil, testProviderRegistryBuilder, nil, nil, nil, nil, nil, nil, nil, nil)
	if err != nil {
...
func TestNewRunnerFactoryUnknown(t *testing.T) {
	...
	_, err := agent.NewRunnerFactory(snap, nil, nil, testProviderRegistryBuilder, nil, nil, nil, nil, nil, nil, nil, nil)
	if err == nil {
...
func TestModelSwitcherPreservesPromptBuilders(t *testing.T) {
	...
	initialFactory, err := agent.NewRunnerFactory(snap, nil, nil, testProviderRegistryBuilder, nil, nil, nil, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("NewRunnerFactory: %v", err)
	}
