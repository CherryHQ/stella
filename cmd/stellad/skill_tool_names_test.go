...
var settingsDefaultDocs = map[string]string{
	filepath.Join("..", "..", "resources", "skills", "core", "stella", "SKILL.md"):                       "Built-in `stella` starts with them enabled; every other Agent starts disabled",
	filepath.Join("..", "..", "resources", "skills", "core", "stella", "references", "configuration.md"): "Stella starts enabled, including after an upgrade",
...
var hotSetDocs = []string{
	...
	filepath.Join("..", "..", "resources", "skills", "core", "stella", "references", "configuration.md"),
