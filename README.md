...
- DAG-based lossless context management (LCM) with SQLite-backed compaction
...
lcm/                                Lossless context management (DAG, compaction, retrieval)
...
| [Memory System](docs/memory-system.md) | LCM (lossless context), facts + journal, tool interface |
