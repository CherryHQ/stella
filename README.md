...
- **Lives in the chat you already use.** Telegram, Discord, QQ, Feishu, WeChat, the Web UI, and the terminal are all front doors to the same agents.
...
| Channels        | Telegram, Discord, QQ, Feishu, WeChat     | [Channels](/docs/channels/telegram)             |
