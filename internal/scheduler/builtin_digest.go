...
// RecallyDigestBuiltin is kept for compile-time compatibility during the Phase 1
// transition. Phase 2 will delete this symbol and the ExecScopeAllUsers path.
//
// Deprecated: use RecallyDigestTemplate and (*Service).RegisterTemplate instead.
