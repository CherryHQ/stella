...
func AgentsPage() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "</div><!-- Sandbox --><div class=\"mb-6 border border-base-300 rounded-box p-4 bg-base-200/40\"><p class=\"text-xs font-mono font-medium text-secondary uppercase tracking-wider mb-3\">Sandbox</p><div class=\"grid grid-cols-1 sm:grid-cols-2 gap-4 items-start\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
