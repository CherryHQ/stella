...
func AgentsPage() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "</div><!-- Soul picker: overwrites system_prompt with selected soul content --><div class=\"mb-4\" x-show=\"!editingId && builtinSouls.length > 0\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Var4 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "<select @change=\"applySoul($event.target.value); $event.target.value = ''\" class=\"select select-bordered w-full text-sm\"><option value=\"\">— pick a soul to fill System Prompt —</option><template x-for=\"soul in builtinSouls\" :key=\"soul.id\"><option :value=\"soul.id\" x-text=\"soul.name + ' — ' + (soul.description || '')\"></option></template></select>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "</div><!-- System prompt (readonly for non-editors) --><div class=\"mb-4\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Var5 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<textarea x-model=\"form.system_prompt\" rows=\"4\" class=\"textarea textarea-bordered w-full text-sm font-mono resize-y\" :disabled=\"editingId && !canEditAgent({creator_id: form.creator_id})\"></textarea>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "</div><!-- Enabled builtin skills (chip selector) --><div class=\"mb-4\" x-show=\"builtinSkills.length > 0\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Var6 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<p class=\"text-xs text-base-content/60 mb-2\">Anna's self-knowledge is always enabled. Toggle extras the agent should see in its prompt catalog.</p><div class=\"flex flex-wrap gap-2\"><template x-for=\"sk in builtinSkills\" :key=\"sk.id\"><button @click=\"toggleBuiltinSkill(sk.name)\" type=\"button\" class=\"badge badge-sm cursor-pointer\" :class=\"isBuiltinSkillEnabled(sk.name) ? 'badge-primary' : 'badge-ghost'\" :title=\"sk.description\"><span x-text=\"sk.name\"></span></button></template></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		})
		templ_7745c5c3_Err = ui.FormField("Enabled builtin skills").Render(templ.WithChildren(ctx, templ_7745c5c3_Var6), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "</div><!-- Sandbox network policy --><div class=\"mb-6 border border-base-300 rounded-box p-4 bg-base-200/40\"><p class=\"text-xs font-mono font-medium text-secondary uppercase tracking-wider mb-3\">Network Policy</p><p class=\"text-xs text-base-content/60 mb-3\">The sandbox backend is configured globally on the <a href=\"/plugins\" class=\"link link-primary\">Plugins</a> page.</p><div class=\"grid grid-cols-1 sm:grid-cols-2 gap-4 items-start mb-4\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Var7 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<select x-model=\"form.sandbox.network.mode\" class=\"select select-bordered w-full text-sm\"><option value=\"disabled\">disabled — block outbound network</option> <option value=\"allow_all\">allow_all — allow outbound network</option> <option value=\"whitelist\">whitelist — only listed hosts/CIDRs</option></select>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		})
		templ_7745c5c3_Err = ui.FormField("Network Mode").Render(templ.WithChildren(ctx, templ_7745c5c3_Var7), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "<div class=\"text-xs text-base-content/60 leading-5 pt-8 sm:pt-0\"><p>Applies to sandboxed core tools: <span class=\"font-mono\">bash</span>, <span class=\"font-mono\">read</span>, <span class=\"font-mono\">write</span>, and <span class=\"font-mono\">edit</span>.</p><p class=\"mt-2\">Whitelist entries accept hostnames, IPs, or CIDRs, one per line.</p></div></div><div class=\"mt-4\" x-show=\"form.sandbox.network.mode === 'whitelist'\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func modelComboField(label string, field string, placeholder string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/admin/ui/pages/agents.templ`, Line: 356, Col: 53}
		}
		...
		templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.JoinStringErrs("form." + field)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/admin/ui/pages/agents.templ`, Line: 363, Col: 27}
		}
		...
		templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs("form." + field + " = $event.target.value; search = $event.target.value; open = cachedModels.length > 0")
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/admin/ui/pages/agents.templ`, Line: 364, Col: 116}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/admin/ui/pages/agents.templ`, Line: 366, Col: 28}
		}
		...
		templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs("form." + field + " = m; open = false")
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/admin/ui/pages/agents.templ`, Line: 378, Col: 52}
		}
		...
		templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs("form." + field + " === m ? 'text-primary' : 'text-base-content/70'")
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/admin/ui/pages/agents.templ`, Line: 381, Col: 82}
		}
