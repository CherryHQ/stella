...
INSERT INTO `new_settings_agents` (`id`, `name`, `model`, `model_strong`, `model_fast`, `system_prompt`, `workspace`, `enabled`, `created_at`, `updated_at`) SELECT `id`, `name`, `model`, `model_strong`, `model_fast`, `system_prompt`, `workspace`, `enabled`, `created_at`, `updated_at` FROM `settings_agents`;
