...
INSERT INTO `new_agent_task` (`id`, `title`, `description`, `status`, `priority`, `session_id`, `context`, `review_request`, `deps`, `notify_at`, `agent_id`, `user_id`, `created_at`, `updated_at`) SELECT `id`, `title`, `description`, `status`, `priority`, `session_id`, `context`, `review_request`, `deps`, `notify_at`, `agent_id`, `user_id`, `created_at`, `updated_at` FROM `agent_task`;
