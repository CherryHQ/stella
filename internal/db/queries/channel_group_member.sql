...
SELECT * FROM channel_group_member WHERE group_id = $1 AND agent_id = $2;
...
SELECT * FROM channel_group_member WHERE agent_id = $1;

-- name: ListGroupsByReplyChannel :many
SELECT * FROM channel_group_member WHERE reply_channel_id = $1;
