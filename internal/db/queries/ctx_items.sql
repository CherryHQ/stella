...
INSERT INTO ctx_items (conversation_id, ordinal, item_type, message_id, summary_id)
VALUES (?, ?, ?, ?, ?);

-- name: GetContextItems :many
SELECT * FROM ctx_items
