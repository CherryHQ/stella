...
CREATE TABLE agent_goal_revision (
    ...
    revision_no         INTEGER NOT NULL DEFAULT 1,                            -- monotonic per goal; replan = revision_no+1
    ...
    source_attempt_id   TEXT REFERENCES agent_goal_attempt(id) ON DELETE SET NULL, -- the decomposition attempt that produced it
