...
SELECT id, name, api_key, base_url, created_at, updated_at FROM providers WHERE id = ?
`
...
SELECT id, name, api_key, base_url, created_at, updated_at FROM providers ORDER BY name
`
