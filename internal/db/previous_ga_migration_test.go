...
const (
	...
	// baseline column, the Settings tool prefix cutover, and the model catalog
	// table are the post-anchor migrations exercised below. Library chunk locator
	// integrity, the dedicated Skill Home cutover evidence schema, retired RTK
	// plugin cleanup, retired Settings tool override cleanup, and the built-in
	// Stella Settings default are checked explicitly.
