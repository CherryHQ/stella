...
const (
	...
	// post-anchor migrations exercised below. Group LCM origin provenance and
	// Group Fact storage are covered by their focused migration tests. Library
	// chunk locator integrity is covered through the rolling-deployment default.
