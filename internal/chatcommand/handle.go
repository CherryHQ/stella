...
// Handle processes common bot commands shared across all channels.
...
func Handle(ctx context.Context, rc *chatroute.ResolvedChat, text, senderID string) (string, bool) {
