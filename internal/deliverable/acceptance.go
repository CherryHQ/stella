...
// Projection is the derived acceptance view of a deliverable — the result of
...
func DeriveAcceptance(c AcceptanceContract, currentOutputHash string, events []sqlc.AgentDlvAcceptanceEvent) Projection {
	// Trivial contract = auto-accept: nothing to evaluate, the deliverable's
...
func latestValidByItem(currentOutputHash string, events []sqlc.AgentDlvAcceptanceEvent) map[string]itemOutcome {
...
func verdictValid(e sqlc.AgentDlvAcceptanceEvent, currentOutputHash string) bool {
