...
- [`+create`](./lark-task/lark-task-create.md) — Create a task
- [`+update`](./lark-task/lark-task-update.md) — Update a task
- [`+comment`](./lark-task/lark-task-comment.md) — Add a comment to a task
- [`+complete`](./lark-task/lark-task-complete.md) — Complete a task
- [`+reopen`](./lark-task/lark-task-reopen.md) — Reopen a task
- [`+assign`](./lark-task/lark-task-assign.md) — Assign or remove members from a task
- [`+followers`](./lark-task/lark-task-followers.md) — Manage task followers
- [`+reminder`](./lark-task/lark-task-reminder.md) — Manage task reminders
- [`+get-my-tasks`](./lark-task/lark-task-get-my-tasks.md) — List tasks assigned to me
- [`+get-related-tasks`](./lark-task/lark-task-get-related-tasks.md) — List tasks related to me
- [`+search`](./lark-task/lark-task-search.md) — Search tasks
- [`+subscribe-event`](./lark-task/lark-task-subscribe-event.md) — Subscribe to task events
- [`+set-ancestor`](./lark-task/lark-task-set-ancestor.md) — Set or clear a task ancestor
- [`+tasklist-create`](./lark-task/lark-task-tasklist-create.md) — Create a tasklist and batch add tasks
- [`+tasklist-search`](./lark-task/lark-task-tasklist-search.md) — Search tasklists
- [`+tasklist-task-add`](./lark-task/lark-task-tasklist-task-add.md) — Add existing tasks to a tasklist
- [`+tasklist-members`](./lark-task/lark-task-tasklist-members.md) — Manage tasklist members
