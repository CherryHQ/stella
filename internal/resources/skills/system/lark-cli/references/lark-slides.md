...
**编辑已有幻灯片页面**：优先用 [`+replace-slide`](./lark-slides/lark-slides-replace-slide.md)（块级替换/插入，不动页序）；选择 action 和完整读-改-写流程见 [`lark-slides-edit-workflows.md`](./lark-slides/lark-slides-edit-workflows.md)。
