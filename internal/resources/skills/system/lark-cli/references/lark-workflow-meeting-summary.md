...
**CRITICAL — 开始前 MUST 先用 Read 工具读取 [`./lark-shared.md`](./lark-shared.md)，其中包含认证、权限处理**。然后阅读 [`./lark-vc.md`](./lark-vc.md)，了解会议纪要相关操作。
...
阅读 [`./lark-doc.md`](./lark-doc.md) 学习云文档技能。
...
- [lark-shared](./lark-shared.md) — 认证、权限（必读）
- [lark-vc](./lark-vc.md) — `+search`、`+notes` 详细用法
- [lark-doc](./lark-doc.md) — `+fetch`、`+create`、`+update` 详细用法