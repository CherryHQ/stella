...
| Shortcut | 说明 |
|----------|------|
| [`+upload`](./lark-drive/lark-drive-upload.md) | Upload a local file to Drive |
...
| [`+add-comment`](./lark-drive/lark-drive-add-comment.md) | Add a full-document comment, or a local comment to selected docx text (also supports wiki URL resolving to doc/docx) |
