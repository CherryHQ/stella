...
export function CollapsibleThinking({
  ...
  return (
    <div className="rounded-xl border border-border bg-card px-4 py-3.5 transition-all duration-120 space-y-3.5 max-w-3xl w-full shadow-none overflow-hidden">
