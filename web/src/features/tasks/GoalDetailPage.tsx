      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          <div className="mx-auto max-w-[1000px] px-6 py-6">
            ...
            {plan && <PlanSection plan={plan} t={t} />}
...
function PlanSection({ plan, t }: { plan: ComponentsGoalPlan; t: TFunction }) {
  // The pending edit, if any, is the plan the user is still shaping; otherwise
  // show the last materialized content.
