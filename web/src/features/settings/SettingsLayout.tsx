...
const settingsNav: {
...
}[] = [
  {
    ...
    items: [
      ...
      {
        id: "webhooks",
        label: "settings.nav.webhooks",
        href: "/settings/webhooks",
        adminOnly: false,
        icon: (
          <WebhookIcon className="size-4 shrink-0 opacity-50 group-[.active]/item:opacity-80" />
        ),
      },
      {
        id: "credentials",
