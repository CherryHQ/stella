            ...
            <div key={group.section}>
              ...
              {visibleItems.map((item) => (
                <Link
                  ...
                  to={item.href as any}
                  className="group/item flex items-center gap-2.5 px-5 py-2 text-[13px] font-medium border-l-2 border-transparent transition-colors text-muted-foreground hover:bg-muted/50 hover:text-foreground"
                  activeProps={{
                    className:
                      "group/item active flex items-center gap-2.5 px-5 py-2 text-[13px] font-medium border-l-2 border-primary bg-primary/4 text-primary transition-colors",
                  }}
                >
                  {item.icon}
                  {item.label}
