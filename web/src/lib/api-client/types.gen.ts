...
export type WorkspaceCreateRequest = {
  /**
   * Relative path for the new file or directory
   */
  path: string;
  /**
   * Create a directory when true; a file when false or omitted
   */
  is_dir?: boolean;
  /**
   * Initial file content (ignored when is_dir is true)
   */
  content?: string;
};
...
export type WorkspaceMoveRequest = {
  ...
  path: string;
  /**
   * New relative path (rename or move destination)
   */
  new_path: string;
};

export type WorkspaceUpdateContentRequest = {
  /**
   * Relative path of the file within the workspace
   */
  path: string;
...
/**
 * STELLA_TOKEN bearer token (generated via vault)
 */
...
export type GetSessionWorkspaceResponse =
  GetSessionWorkspaceResponses[keyof GetSessionWorkspaceResponses];
...
export type DeleteWorkspaceFileResponse =
  DeleteWorkspaceFileResponses[keyof DeleteWorkspaceFileResponses];
...
export type MoveWorkspaceFileResponse =
  MoveWorkspaceFileResponses[keyof MoveWorkspaceFileResponses];
...
export type GetWorkspaceFileContentData = {
  ...
  query: {
    ...
    path: string;
    /**
     * When true, serve the file bytes directly with the detected Content-Type instead of a JSON envelope
     */
    raw?: boolean;
  };
...
export type GetWorkspaceFileContentError =
  GetWorkspaceFileContentErrors[keyof GetWorkspaceFileContentErrors];

export type GetWorkspaceFileContentResponses = {
  /**
   * ok
   */
...
export type GetWorkspaceFileContentResponse =
  GetWorkspaceFileContentResponses[keyof GetWorkspaceFileContentResponses];
...
export type UpdateWorkspaceFileContentError =
  UpdateWorkspaceFileContentErrors[keyof UpdateWorkspaceFileContentErrors];

export type UpdateWorkspaceFileContentResponses = {
  /**
   * ok
   */
  200: WorkspaceFileContent;
