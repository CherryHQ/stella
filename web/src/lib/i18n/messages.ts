...
const en = {
  ...
  "channels.feishuGroupChatId": "Chat ID",
  "channels.feishuGroupChatIdDesc": "Copy the Feishu chat ID, which normally starts with oc_.",
...
const zh = {
  ...
  "channels.feishuGroupChatId": "群聊 ID",
  "channels.feishuGroupChatIdDesc": "填写飞书群聊 ID，通常以 oc_ 开头。",
