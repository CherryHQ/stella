...
const en = {
  ...
  "agents.skills.scopeCore": "Core",
  "agents.skills.scopePlugin": "Plugin",
  "agents.skills.pluginSettings": "Plugin settings",
  ...
  "channels.feishuGroupsSaveFirst": "Save and enable this channel before choosing groups.",
  "channels.feishuGroupsLoading": "Loading groups this bot has joined...",
  "channels.feishuGroupsLoadFailed":
    "Couldn't load groups. Check that this channel is enabled and connected.",
...
const zh = {
  ...
  "agents.skills.scopeCore": "核心",
  "agents.skills.scopePlugin": "插件",
  "agents.skills.pluginSettings": "插件设置",
  ...
  "channels.feishuGroupsSaveFirst": "请先保存并启用此渠道，再选择群聊。",
  "channels.feishuGroupsLoading": "正在加载机器人已加入的群聊...",
  "channels.feishuGroupsLoadFailed": "无法加载群聊。请检查此渠道是否已启用并连接成功。",
