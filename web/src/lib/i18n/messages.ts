...
const en = {
  ...
  "agents.tools.description":
    "Only these runnable built-in and plugin tools accept visibility overrides. Administrator restrictions win.",
  ...
  "agents.tools.empty": "No override-capable tools are registered",
  ...
  "agents.tools.system.description":
    "Read-only policy catalog for Stella’s conversational settings actions.",
  "agents.tools.system.badge.stellaOnly": "Stella only",
...
const zh = {
  ...
  "agents.tools.system.description": "Stella 对话式设置动作的只读策略目录。",
  "agents.tools.system.badge.stellaOnly": "仅 Stella",
