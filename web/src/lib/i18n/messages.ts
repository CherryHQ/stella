...
const en = {
  ...
  "providers.modelsHint":
    "Toggle models on or off. Changes save immediately; custom models can be edited below.",
  ...
  "providers.selectedModels": "selected",
  "providers.free": "Free",
  "providers.catalog": "catalog",
  "providers.override": "override",
...
const zh = {
  ...
  "providers.modelsHint": "模型开关会立即保存。自定义模型可在下方编辑。",
  "providers.searchModels": "搜索模型",
  "providers.allSources": "全部来源",
  "providers.allStatuses": "全部状态",
  "providers.bulkDisable": "禁用所选",
  "providers.selectedModels": "已选择",
  "providers.free": "免费",
  "providers.catalog": "目录",
  "providers.override": "覆盖",
