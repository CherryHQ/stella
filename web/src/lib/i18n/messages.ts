...
const en = {
  ...
  "sessions.discover.previewNote":
    "Preview — example catalog shown while the discovery service is under construction.",
...
const zh: Record<MessageKey, string> = {
  ...
  "sessions.skill.clawhub": "ClawHub",
  "sessions.discover.previewNote": "预览 — 发现服务建设中，以下为示例数据。",
