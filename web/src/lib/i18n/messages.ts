...
const en = {
  ...
  "goals.blockBudget": "Attempt budget exhausted",
  "goals.blockDep": "Blocked on a dependency",
  ...
  "goals.hookBudget": "Out of attempts — reattempt or abandon",
  "goals.hookDep": "Blocked on a dependency",
  ...
  "goals.openSession": "Open session",
...
const zh: Record<MessageKey, string> = {
  ...
  "goals.blockBudget": "尝试次数已用尽",
  "goals.blockDep": "被依赖项阻塞",
  ...
  "goals.hookBudget": "尝试次数已用尽 — 重试或放弃",
  "goals.hookDep": "被依赖项阻塞",
