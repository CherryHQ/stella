...
const en = {
  ...
  "library.description.user": "Personal files available to every Agent you use.",
  "library.description.userAgent": "Personal files available only when you use {{agent}}.",
  "library.description.system": "Company files available to every user and Agent.",
  "library.description.systemAgent":
    "Company files available whenever anyone uses the selected Agent.",
  ...
  "library.agent.requiredDesc": "Choose which Agent should receive these company files.",
  ...
  "library.empty.description":
    "Upload a supported file and its content will become available for retrieval after processing.",
  ...
  "library.upload.description":
    "Each file is uploaded separately. Processing continues in the background after upload.",
  ...
  "library.delete.description":
    "{{name}} will immediately stop being available for retrieval. This action cannot be undone.",
  ...
  "channels.weixinSingletonDesc":
    "WeChat is singleton-only: one deployment has one WeChat channel.",
...
const zh: Record<MessageKey, string> = {
  ...
  // Library
  "library.title": "知识库",
  "library.description.user": "这里的个人知识可供你使用的所有智能体检索。",
  "library.description.userAgent": "这里的个人知识仅在你使用 {{agent}} 时可供检索。",
  "library.description.system": "这里的企业知识可供所有用户和智能体检索。",
  "library.description.systemAgent": "这里的企业知识在任何人使用所选智能体时可供检索。",
  ...
  "library.agent.requiredDesc": "选择这批企业知识要提供给哪个智能体。",
  ...
  "library.empty.description": "上传支持的文件，处理完成后其内容即可用于检索。",
  ...
  "library.upload.description": "每个文件会单独上传；上传完成后，解析将在后台继续进行。",
  ...
  "library.delete.description": "{{name}} 将立即停止参与检索，且无法恢复。",
  ...
  "channels.weixinSingletonDesc": "微信是单例渠道：一个部署只有一个微信渠道。",
