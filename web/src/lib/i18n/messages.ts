...
const en = {
  ...
  "goals.planEditorHint":
    "Author the plan as JSON: an items array, each with id, title, role (design/impl/verify), deps (item ids), and criteria.",
  "goals.planJsonLabel": "Plan content (JSON)",
  ...
  "goals.planInvalidJson": "Invalid JSON: {{error}}",
  "goals.planNeedsItems": "Plan needs a non-empty items array; each item needs an id and title.",
...
const zh: Record<MessageKey, string> = {
  ...
  "goals.planEditorHint":
    "用 JSON 编写计划：items 数组，每项含 id、title、role（design/impl/verify）、deps（item id）和 criteria。",
  "goals.planJsonLabel": "计划内容（JSON）",
  ...
  "goals.planInvalidJson": "JSON 无效：{{error}}",
  "goals.planNeedsItems": "计划需要非空的 items 数组；每项需要 id 和 title。",
