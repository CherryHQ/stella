...
const en = {
  ...
  "providers.modelsHint":
    "Model changes save as you make them. Expand a model to see where each value comes from and pin your own.",
  ...
  "providers.overriddenOnly": "Overridden only",
...
const zh = {
  ...
  "providers.modelsHint": "模型改动会即时保存。展开模型可查看每个值的来源，并按需覆盖。",
