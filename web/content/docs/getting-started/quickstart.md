...
Stella starts and serves the admin panel at [http://localhost:25678](http://localhost:25678). Open it in your browser.
...
1. Open the admin panel at [http://localhost:25678](http://localhost:25678).
...
If you already set an environment variable in the previous step, Stella picks it up automatically as a fallback. Configuring the provider in the admin panel gives you more control over which models to use.

## Have your first conversation

You have two options:

**From the admin panel:** Open the **Chat** section and start typing. Stella responds using your configured model.
...
- [Configure agents, models, and settings](/docs/getting-started/configuration) in the admin panel
