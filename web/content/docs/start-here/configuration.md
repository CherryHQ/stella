...
| Plugins                  | `settings_plugin_list`, `settings_plugin_enable`, `settings_plugin_disable`                                                                     | Administrator only; use the exact `plugin_id` returned by the list. Arbitrary configuration writes are unavailable. |
