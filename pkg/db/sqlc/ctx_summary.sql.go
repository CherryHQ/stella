...
SELECT m.id, m.conversation_id, m.seq, m.role, m.event_type, m.content, m.token_count, m.created_at, m.actor_type, m.actor_id, m.source_session_id, m.inbox_id, m.origin_group_message_id, m.execution_metadata FROM ctx_message m
