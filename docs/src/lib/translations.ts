const translations = {
  en: {
    ...
    // Index - Features
    featuresTitle: 'What makes anna different',
    ...
    // Index - Meet Anna
    meetAnna: 'Meet Anna',
    meetAnnaTitle: 'A calm digital companion',
    meetAnnaBody1:
    ...
    learnMoreAboutAnna: 'Learn more about Anna',
    // Index - Footer CTA
    ...
    aboutHeroDescription:
      'Anna is a self-hosted AI assistant with real warmth and digital precision. She remembers what you said, connects your workflows across devices, and stays quietly useful — day after day.',
    // About - Traits
    traitsTitle: 'What defines Anna',
    traitsIntro: 'Anna is not another generic AI chatbot. She is a',
    ...
    traitCalm: 'Calm',
    traitCalmDesc: 'Quiet intelligence over loud marketing. Anna speaks with clarity, not hype.',
    ...
    visualIdentityIntro:
      "Anna's look is intentional: a semi-realistic portrait that feels human but is clearly a brand character. She looks like someone real — but she is a digital assistant, and that distinction matters.",
    idPalette: 'Palette',
    idPaletteDetail:
    ...
    builtToStayBody:
      'Anna is not about making noise. She earns trust over time — through consistent memory, reliable assistance, and quiet presence. The kind of assistant you keep coming back to.',
  },
  zh: {
    about: '关于',
    docs: '文档',
    ...
    heroTitle2: '永远不会',
    heroTitle3: '遗忘',
    heroDescription: '单一二进制文件，无损上下文管理。在终端或任何即时通讯中对话——anna 记住一切。',
    readTheDocs: '阅读文档',
    sourceOnGithub: 'GitHub 源码',
    featuresTitle: 'anna 的独特之处',
    feature1Title: '无损记忆',
    feature1Body:
    ...
    feature4Title: '内置调度器',
    feature4Body: '定时任务、心跳监控和跨渠道通知。即使你不和 anna 对话，她也在工作。',
    meetAnna: '认识 Anna',
    meetAnnaTitle: '一位沉静的数字伙伴',
    meetAnnaBody1:
      'Anna 不仅仅是一个工具——她是一位安静、值得信赖的助手，为长期陪伴而设计。她记住你的上下文，连接你跨设备的工作流，始终可靠地陪伴而不打扰。',
    meetAnnaBody2: '融合真实温度与数字精确。本地优先、记忆感知、始终沉着。',
    learnMoreAboutAnna: '了解更多关于 Anna',
    getStarted: '几秒钟即可开始',
    ...
    aboutHeroTitle3: '伙伴',
    aboutHeroDescription:
      'Anna 是一个自托管的 AI 助手，兼具真实温度与数字精确。她记住你说过的话，连接你跨设备的工作流，日复一日地安静而有用。',
    traitsTitle: 'Anna 的特质',
    traitsIntro: 'Anna 不是另一个普通的 AI 聊天机器人。她是一位',
    traitsIntroBold: '沉静的数字伙伴',
    traitsIntroEnd: '——值得信赖、持久陪伴、深刻感知你的上下文。',
    traitCalm: '沉静',
    traitCalmDesc: '安静的智慧胜过喧嚣的营销。Anna 以清晰而非炒作来表达。',
    ...
    traitLocalFirstDesc:
      '你的机器，你的数据。Anna 以单一二进制文件和 SQLite 运行——数据不会离开你的网络。',
    traitCompanion: '陪伴',
    traitCompanionDesc: '不是一次性工具。Anna 为长期陪伴而设计——一位与你共同成长的数字助手。',
    traitElegant: '优雅',
    traitElegantDesc: '简约而克制。没有杂乱，没有噪音。恰到好处的存在感。',
    visualIdentity: '视觉形象',
    visualIdentityIntro:
      'Anna 的外观是精心设计的：一幅半写实的肖像，既有人的感觉又明显是品牌角色。她看起来像一个真实的人——但她是数字助手，这种区分很重要。',
    idPalette: '配色',
    ...
    builtToStay: '为留下而生',
    builtToStayBody:
      'Anna 不追求喧嚣。她通过持久的记忆、可靠的帮助和安静的陪伴赢得信任。那种你会一直回来找的助手。',
  },
  ja: {
    about: 'アバウト',
    docs: 'ドキュメント',
    heroTag: 'AIアシスタント / セルフホスト',
    heroTitle1: 'あなたのアシスタント',
    heroTitle2: '何も',
    heroTitle3: '忘れない',
    heroDescription:
      'シングルバイナリ、ロスレスコンテキスト管理。ターミナルやメッセンジャーから会話——annaはすべてを記憶します。',
    readTheDocs: 'ドキュメントを読む',
    sourceOnGithub: 'GitHubソース',
    featuresTitle: 'annaの違い',
    feature1Title: 'ロスレスメモリ',
    feature1Body:
      'DAGベースのコンテキスト圧縮。会話は制限なく成長し、一つの詳細も失いません。すべてのスレッド、すべての分岐が保存されます。',
    feature2Title: 'マルチチャネル',
    feature2Body:
      'ターミナルTUI、Telegram、QQ、Feishu。すべてのチャネルが同じセッションとメモリを共有。ターミナルで始めた会話をTelegramで続けられます。',
    feature3Title: 'セルフホスト',
    feature3Body:
      'シングルGoバイナリ + SQLite。あなたのマシン、あなたのAPIキー。データはネットワーク外に出ません。Docker、systemd、またはバイナリ直接実行で展開。',
    feature4Title: '内蔵スケジューラ',
    feature4Body:
      'スケジュールタスク、ハートビート監視、クロスチャネル通知。annaはあなたが話しかけていない時も動いています。',
    meetAnna: 'Annaについて',
    meetAnnaTitle: '穏やかなデジタルコンパニオン',
    meetAnnaBody1:
      'Annaは単なるツールではありません——長期的な付き合いのために設計された、静かで信頼できるアシスタントです。あなたのコンテキストを記憶し、デバイス間のワークフローをつなぎ、邪魔にならずに寄り添います。',
    meetAnnaBody2:
      '本物の温かさとデジタルの正確さを兼ね備えて。ローカルファースト、メモリアウェア、常に落ち着いて。',
    learnMoreAboutAnna: 'Annaについてもっと知る',
    getStarted: '数秒で始められます',
    getStartedBody: 'バイナリ1つ、設定ファイル1つ。コンテナ不要。',
    aboutHeroTitle1: '静かで、',
    aboutHeroTitle2: '頼れる',
    aboutHeroTitle3: 'コンパニオン',
    aboutHeroDescription:
      'Annaはセルフホスト型のAIアシスタントで、本物の温かさとデジタルの正確さを持っています。あなたの言葉を記憶し、デバイス間のワークフローをつなぎ、日々静かに役立ち続けます。',
    traitsTitle: 'Annaを定義するもの',
    traitsIntro: 'Annaは平凡なAIチャットボットではありません。彼女は',
    traitsIntroBold: '穏やかなデジタルコンパニオン',
    traitsIntroEnd: '——信頼でき、長く寄り添い、あなたのコンテキストを深く理解します。',
    traitCalm: '穏やか',
    traitCalmDesc: '喧騒なマーケティングより静かな知性。Annaは誇張ではなく明瞭さで語ります。',
    traitTrustworthy: '信頼できる',
    traitTrustworthyDesc:
      '安定して一貫性がある。あなたのコンテキストを記憶し、細部を見逃しません。',
    traitMemoryAware: 'メモリアウェア',
    traitMemoryAwareDesc:
      '長期コンテキストは後付けではなく、第一級の機能。すべての会話が前回の続きです。',
    traitLocalFirst: 'ローカルファースト',
    traitLocalFirstDesc:
      'あなたのマシン、あなたのデータ。AnnaはシングルバイナリとSQLiteで動作——データはネットワーク外に出ません。',
    traitCompanion: 'コンパニオン',
    traitCompanionDesc:
      '使い捨てツールではありません。Annaは長期的な付き合いのために設計された、あなたと共に成長するデジタルアシスタントです。',
    traitElegant: 'エレガント',
    traitElegantDesc: 'ミニマルで控えめ。雑然とせず、ノイズもない。ちょうど良い存在感。',
    visualIdentity: 'ビジュアルアイデンティティ',
    visualIdentityIntro:
      'Annaの外見は意図的です：人間らしさを感じさせつつ明確にブランドキャラクターである半写実的な肖像。実在の人物のように見えますが、デジタルアシスタントであり、その区別は重要です。',
    idPalette: 'パレット',
    idPaletteDetail:
      'ディープネイビーブルーにシャンパンゴールドのアクセント。ブルーは信頼と静けさ、ゴールドは温かさと記憶を表します。',
    idExpression: '表情',
    idExpressionDetail:
      '落ち着いた、穏やかな、注意深い。過度に明るくなく、冷たくもない。耳を傾ける人の印象。',
    idBackground: '背景',
    idBackgroundDetail:
      '繊細なメモリネットワークモチーフ——長期コンテキストを暗示する淡いノードと接続線、主張しすぎない。',
    idStyle: 'スタイル',
    idStyleDetail:
      '70%の写真的リアリズム、30%のブランドスタイリゼーション。自然な肌質感、柔らかいポートレートライティング、小さいサイズでも認識可能。',
    swatchNavy: 'ネイビー',
    swatchMidBlue: 'ミッドブルー',
    swatchGold: 'ゴールド',
    swatchCaption: 'ディープネイビー + シャンパンゴールド',
    builtToStay: '長く寄り添うために',
    builtToStayBody:
      'Annaは騒がしさを求めません。一貫したメモリ、信頼できるアシスタンス、静かな存在感を通じて信頼を積み重ねます。何度も戻ってくるようなアシスタントです。',
  },
} as const;
