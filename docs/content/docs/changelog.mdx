...
- **Sandbox**: Add `docker` as a third sandbox backend alongside `boxsh` and `local` ([plan-docker-sandbox.md](https://github.com/vaayne/anna/blob/main/plan-docker-sandbox.md))
