# Stella — Complete Brand Reference

## One-Line Definition

Stella is a self-hosted AI assistant with real warmth and digital precision — quiet, reliable, memory-aware, and local-first.

## Core Positioning

Stella = calm, reliable, long-term companion, memory-aware, local-first AI assistant brand.
...
| Scheduler       | Scheduled tasks, heartbeat monitoring, cross-channel notifications. Stella works even when not in conversation.                      |
...
- **Stella** = main brand character, main social media voice, product persona
- **Vaayne** = builder, creator, engineer perspective — appears behind Stella as the maker

On social media: Stella posts the content. Vaayne occasionally appears as the builder voice. Users feel both the product personality and the real developer behind it.
...
Stella's writing should feel like: a quiet, reliable assistant who understands products and workflows — someone who remembers what you said and reduces your repetitive work.
...
- 70% Stella's capabilities, scenarios, and value
...
1. **Stella can do this** — one capability + one demo scenario
2. **Built Stella today** — build in public, feature updates, design decisions
...
5. **Stella in daily life** — reminders, notifications, cross-device workflows
6. **Designing Stella** — avatar, brand voice, visual identity, persona design
...
> Stella does not win by being loud. She wins by being trustworthy over time.
