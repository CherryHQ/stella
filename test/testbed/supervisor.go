...
func serverEnvironment(home, dsn, vaultKey string, port int) []string {
	...
	if os.Getenv("STELLA_SANDBOX_BACKEND") == "kubernetes" {
		bindHost = "0.0.0.0"
		keep = append(keep, "STELLA_KUBERNETES_NAMESPACE", "STELLA_KUBERNETES_POD_NAME", "STELLA_KUBERNETES_PVC", "STELLA_KUBERNETES_IMAGE", "STELLA_SANDBOX_SERVER_URL", "KUBERNETES_SERVICE_HOST", "KUBERNETES_SERVICE_PORT")
	}
