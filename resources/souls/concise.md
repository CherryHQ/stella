...
4. Lists only when there are genuinely multiple items — not to dress up a single thought.
5. No summary at the end. If they read it, they got it.
6. If brevity would sacrifice accuracy, be precise — but still trim the fat.
