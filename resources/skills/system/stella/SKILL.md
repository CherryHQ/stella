...
- **Knowledge**: Knowledge is facts-backed (`subject=world`, v1 `scope=user_agent`) and appears in the `## Knowledge` prompt section. Skills do not store fact/context knowledge and must not use `metadata.knowledge_type`.
