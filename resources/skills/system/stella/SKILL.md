...
stella skills remove <s>        # Remove a skill
...
Memory and task are agent tools; scheduler, skills, vault, oauth, and notifications are managed via the `stella` CLI (use `bash` to call them). Briefly:
