...
// builtin plugin catalog that Stella ships with its binary. Plugin-owned
...
// BuiltinPluginsJSON returns the generated release plugin catalog.
func BuiltinPluginsJSON() []byte { return []byte(builtinPluginsJSON) }
